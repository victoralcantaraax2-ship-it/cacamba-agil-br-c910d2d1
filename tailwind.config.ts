  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-green": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(145 70% 42% / 0.5)" },
          "50%": { boxShadow: "0 0 0 12px hsl(145 70% 42% / 0)" },
        },
        "bounce-subtle": {
        ...
        "glow-breathe": {
          "0%, 100%": { opacity: "0.7" },
          "50%": { opacity: "1", textShadow: "0 0 8px hsl(22 75% 52% / 0.4)" },
        },
        "border-glow": {
          "0%, 100%": { boxShadow: "0 0 8px 0 hsl(var(--primary) / 0.15)" },
          "50%": { boxShadow: "0 0 18px 2px hsl(var(--primary) / 0.3)" },
        },
        "btn-breathe": {
