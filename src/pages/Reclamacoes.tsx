...
const complaints = [
  ...
  {
    id: "245820451", title: "Primeira locação e foi excelente", author: "Roberto Alves",
    city: "Taboão da Serra", date: "14/04/2026", status: "Resolvida",
    tags: ["Elogio", "Primeira experiência"],
    text: "Primeira vez que alugo caçamba e estava com receio. A NORTEX me surpreendeu positivamente. Chegou antes do horário, motorista educado e ainda me explicou como usar corretamente.",
    response: "Roberto, é um prazer ter sido sua primeira experiência! Queremos que cada cliente se sinta seguro e bem orientado. Obrigado pela confiança!",
    finalNote: "Muito satisfeito. Já vou precisar novamente e já sei onde contratar. ★★★★★",
  },
  {
    id: "245815672", title: "Atendimento via WhatsApp é top", author: "Mariana Silva",
    city: "Mauá", date: "15/04/2026", status: "Resolvida",
    tags: ["Elogio", "Atendimento WhatsApp"],
    text: "Resolvi tudo pelo WhatsApp, sem precisar ligar. Mandei foto do local, recebi orçamento na hora e agendei. Super prático e rápido.",
    response: "Mariana, investimos no atendimento digital justamente para facilitar a vida dos clientes. Ficamos felizes que aproveitou!",
    finalNote: null,
  },
  {
    id: "245824890", title: "Preço justo e sem surpresas", author: "Luiz Carlos",
    city: "Cotia", date: "16/04/2026", status: "Resolvida",
    tags: ["Elogio", "Preço"],
    text: "Cotei em 3 empresas e a NORTEX tinha o melhor custo-benefício. O valor que me passaram foi exatamente o que paguei, sem taxa escondida.",
    response: "Luiz, transparência é um dos nossos pilares. O preço que informamos é o preço final, sem surpresas. Obrigado pela preferência!",
    finalNote: "Empresa honesta. Recomendo. ★★★★★",
  },
  {
    id: "245828103", title: "Caçamba ideal para minha necessidade", author: "Daniela Pereira",
    city: "São Paulo – Vila Mariana", date: "17/04/2026", status: "Resolvida",
    tags: ["Elogio", "Orientação técnica"],
    text: "Não sabia qual tamanho contratar. A atendente me fez algumas perguntas e recomendou a de 5m³. Coube tudo certinho, sem sobrar nem faltar.",
    response: "Daniela, orientar o cliente a escolher o tamanho correto evita custos desnecessários e garante satisfação. Ficamos felizes em ajudar!",
    finalNote: null,
  },
  {
    id: "245832547", title: "Retirada pontual mesmo em feriado", author: "Carlos Henrique",
    city: "Embu das Artes", date: "18/04/2026", status: "Resolvida",
    tags: ["Elogio", "Pontualidade"],
    text: "Precisava que retirassem em um feriado e a NORTEX atendeu sem cobrar taxa extra. Vieram no horário combinado. Profissionalismo total.",
    response: "Carlos, operamos também em feriados para atender demandas especiais. Seu elogio nos motiva a continuar!",
    finalNote: "Empresa diferenciada. Vale cada centavo. ★★★★★",
  },
  {
    id: "245837921", title: "Reforma de condomínio sem problemas", author: "Síndico José Antônio",
    city: "Diadema", date: "19/04/2026", status: "Resolvida",
    tags: ["Elogio", "Condomínio"],
    text: "Reforma das áreas comuns do prédio. A NORTEX entregou 2 caçambas e trocou quando encheram. Processo todo muito organizado.",
    response: "José Antônio, atender condomínios exige organização e pontualidade. Ficamos satisfeitos que tudo correu bem!",
    finalNote: null,
  },
  {
    id: "245841208", title: "Indicação do meu pedreiro", author: "Beatriz Costa",
    city: "Itaquaquecetuba", date: "20/04/2026", status: "Resolvida",
    tags: ["Elogio", "Indicação"],
    text: "Meu pedreiro indicou a NORTEX e não me arrependi. Serviço sério, pontual e preço dentro do orçamento.",
    response: "Beatriz, indicações de profissionais da construção civil são um voto de confiança. Obrigado!",
    finalNote: "Super recomendo. ★★★★★",
  },
];
